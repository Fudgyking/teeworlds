...
MACRO_CONFIG_INT(DemoSort, demo_sort, 0, 0, 256, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Sort criterion for the demo browser")
MACRO_CONFIG_INT(DemoSortOrder, demo_sort_order, 0, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Sort order in the demo browser")
